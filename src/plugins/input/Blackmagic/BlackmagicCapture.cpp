...
namespace omni {
  namespace input {
	...
	BMDDisplayModeSupport			displayModeSupported;
      ...
      qDebug() << (result == S_OK ? "Started..." : "Not started");
    ...
    void BlackmagicCapture::update() {
     ...
     // qDebug() << "Update texture: " << size_ << videoFrameSize_ << displayMode_->GetWidth();
