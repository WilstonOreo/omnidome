...
namespace omni {
    namespace ui {
        namespace proj {
            ...
            /// Reset to free projector setup (discards previous projector
            // setup)
            ...
            void Tuning::updateParameters()
            {
                ...
                tuning()->setOverlapOpacity(getParamAsFloat("Overlap Opacity"));
            ...
            void Tuning::setup()
            {
                ...
                auto *_overlapOpacity =
                    addWidget("Overlap Opacity", 0.0, 0.0, 1.0);
                _overlapOpacity->setSingleStep(0.01);
                _overlapOpacity->setPageStep(0.05);
                _overlapOpacity->setGripSize(0);
